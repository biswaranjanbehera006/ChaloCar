...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between relative overflow-hidden">
      ...
      {/* Footer */}
      <footer className="w-full py-10 px-8 bg-black/70 backdrop-blur-md text-sm text-white flex flex-col md:flex-row items-start justify-between gap-8 border-t border-white/10">
